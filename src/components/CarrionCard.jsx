...
const cover = "https://cdn1.epicgames.com/7c6d889f36124ae4b6269f8e1698a547/offer/EGS_CARRION_PhobiaGameStudio_S3-2560x1440-790cef9b876a79f75582490ebd1e6ee4.jpg";
    ...
    return (
        <Link to="/carrion">
            <article class="group relative isolate flex flex-col justify-end overflow-hidden rounded-xl w-270 h-150">
                ...
                <h3 id="gameName" class="z-10 mt-3 text-4xl font-bold text-gray-100  ">Carrion</h3>
